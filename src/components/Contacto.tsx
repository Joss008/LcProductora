    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          {/* Form - first on mobile, first on desktop */}
          <div>
            <Reveal delay={2}>
              <form
          ...
          {/* Contact cards - second on mobile, second on desktop */}
          <div>
            <div className="space-y-4">
              <Reveal delay={3}>
                <a
                ...
                >
                  ...
                  <span className="text-white text-sm font-semibold">+51 960 597 159</span>
                </a>
              </Reveal>
              ...
              <Reveal delay={4}>
                ...
                >
                  ...
                  <span className="text-white text-sm font-semibold">LC Productora de eventos</span>
                </a>
              </Reveal>
              ...
              <Reveal delay={5}>
                ...
                >
                  ...
                  <span className="text-white text-sm font-semibold">lcproductoradeeventos@gmail.com</span>
                </a>
              </Reveal>
            </div>
          </div>
